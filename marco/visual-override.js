...
var generateOverride = function (params) {
    ...
    if (params.textFont !== 'Montserrat') {
		...
		blockquote,
		figcaption{
               font-family: ${params.textFont};
        }`;
    }
    if (params.textFontWeight !== '400') {
        output += `
        body,
		blockquote,
		figcaption{
    ...
    if (params.headlineFont !== 'Montserrat') {
        output += `
        h1,
        h2,
        h3,
        ...
        h5,
        h6 {
               font-family: ${params.headlineFont};
        }`;
    }

    if (params.headlineFontWeight !== '400') {
        output += `
        h1,
        h2,
        h3,
        ...
        h5,
        h6 {
               font-weight: ${params.headlineFontWeight};
        }`;
    }
